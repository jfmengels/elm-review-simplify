...
- [🔧 `Simplify`](https://package.elm-lang.org/packages/jfmengels/elm-review-simplify/2.0.24/Simplify/ "Provides automatic fixes") - Reports when an expression can be simplified.
